...
<head>
    ...
    <title>Edit Topic - Studyhive</title>
    ...
    <div class="main-content">
        <div class="form-container">
            <div class="breadcrumb">
                ...
                <i class="fas fa-chevron-right"></i>
                <a href="{{ route('topics.show', $topic) }}">{{ $topic->topic_number }}</a>
                <i class="fas fa-chevron-right"></i>
                <span>Edit</span>
            </div>
            ...
            <form action="{{ route('topics.update', $topic) }}" method="POST" enctype="multipart/form-data" class="form-card">
                @csrf
                @method('PUT')
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="topic_number" name="topic_number" value="{{ old('topic_number', $topic->topic_number) }}" required placeholder="e.g., T-01">
                        <small>A unique identifier for this topic</small>
                    </div>

                    <div class="form-group">
                        <label for="order">Display Order <span class="required">*</span></label>
                        <input type="number" id="order" name="order" value="{{ old('order', $topic->order) }}" required min="0">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $topic->title) }}" required placeholder="Enter the topic title">
                </div>

                <div class="form-group">
                    <label for="content">Content</label>
                    <textarea id="content" name="content" class="content-editor" placeholder="Enter the topic content here...">{{ old('content', $topic->content) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    @if($topic->file_path)
                        <div class="current-file">
                            ...
                            <span>{{ $topic->original_filename ?? 'Current file' }}</span>
                            <a href="{{ route('topics.download', $topic) }}">
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('topics.show', $topic) }}" class="btn-cancel">
