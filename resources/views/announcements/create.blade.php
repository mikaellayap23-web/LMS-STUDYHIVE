...
<head>
    ...
    <title>Create Announcement - Studyhive</title>
...
<body>
    ...
    <div class="main-content">
        <div class="form-container">
            ...
            <form action="{{ route('announcements.store') }}" method="POST" class="form-card">
                @csrf

                <div class="form-group">
                    <label for="title">Title</label>
                    <input type="text" id="title" name="title" value="{{ old('title') }}" required placeholder="Enter announcement title">
                </div>

                <div class="form-group">
                    <label for="content">Content</label>
                    <textarea id="content" name="content" required placeholder="Enter announcement content">{{ old('content') }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="target_audience" name="target_audience" required>
                        ...
                        <option value="teacher" {{ old('target_audience') === 'teacher' ? 'selected' : '' }}>Teachers Only</option>
