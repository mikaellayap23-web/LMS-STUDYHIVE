...
<head>
    ...
    <title>Edit Course - Studyhive</title>
...
<body>
    ...
    <div class="main-content">
        <div class="form-container">
            ...
            <form action="{{ route('courses.update', $course) }}" method="POST" class="form-card">
                @csrf
                @method('PUT')
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="course_code" name="course_code" value="{{ old('course_code', $course->course_code) }}" required placeholder="e.g., CS101">
                        <small>A unique identifier for the course</small>
                    </div>

                    <div class="form-group">
                        <label for="sector">Sector / Department</label>
                        <input type="text" id="sector" name="sector" value="{{ old('sector', $course->sector) }}" placeholder="e.g., Computer Science">
                    </div>
                </div>

                <div class="form-group">
                    <label for="course_name">Course Name <span class="required">*</span></label>
                    <input type="text" id="course_name" name="course_name" value="{{ old('course_name', $course->course_name) }}" required placeholder="Enter the course name">
                </div>

                <div class="form-group">
                    <label for="description">Description</label>
                    <textarea id="description" name="description" placeholder="Provide a brief description of the course">{{ old('description', $course->description) }}</textarea>
                </div>
